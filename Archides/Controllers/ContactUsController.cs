...
namespace Archides.Controllers
{
    public class ContactUsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ContactUsID,Emri,Email,Subject,Mesazhi")] ContactU contactU)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ContactUsID,Emri,Email,Subject,Mesazhi")] ContactU contactU)
        {
            if (ModelState.IsValid)
            {
